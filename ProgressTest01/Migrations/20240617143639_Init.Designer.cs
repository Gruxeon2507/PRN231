...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProgressTest01.Models.Author", b =>
                {
            ...
            modelBuilder.Entity("ProgressTest01.Models.Book", b =>
                {
            ...
            modelBuilder.Entity("ProgressTest01.Models.BookAuthor", b =>
                {
                    b.Property<int?>("Book_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProgressTest01.Models.Publisher", b =>
                {
                    b.Property<int>("Pub_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProgressTest01.Models.Book", b =>
                {
                    b.HasOne("ProgressTest01.Models.Publisher", "Publisher")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("ProgressTest01.Models.BookAuthor", b =>
                {
                    b.HasOne("ProgressTest01.Models.Author", "Author")
                        .WithMany("BookAuthors")
                        .HasForeignKey("Author_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ProgressTest01.Models.Book", "Book")
                        .WithMany("BookAuthors")
